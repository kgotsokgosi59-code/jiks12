/* playlist.js — the background music track list. DATA ONLY, no logic.
   ...
   To switch the music on: drop your licensed MP3s into  assets/audio/music/
   and make sure the `file` below matches each filename. Leave `file` empty for
   any track you haven't added yet — the player skips it and says so.

   These titles are listed as a starting point. Use music you have the rights
